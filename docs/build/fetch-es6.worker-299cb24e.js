import {f as consoleError} from './index-22141a71.js';
...
const workerPromise = import('./fetch-es6.worker-c2391652.js').then(m => m.worker);
...
export { createWorker as c, getFeedsSingleObserver as g, loadFeedRanking as l };
