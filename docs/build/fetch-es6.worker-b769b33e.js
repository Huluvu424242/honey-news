import { c as createWorker } from './fetch-es6.worker-9fb2fb85.js';
import './index-6cdc66d3.js';

const workerName = 'fetch-es6.worker';
const workerMsgId = 'stencil.fetch-es6.worker';
const workerPath = /*@__PURE__*/new URL('fetch-es6.worker-e3b38922.js', import.meta.url).href;
