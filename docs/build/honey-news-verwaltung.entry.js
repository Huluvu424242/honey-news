...
import { c as createCommonjsModule, a as commonjsGlobal, n as newsService } from './news-service-5f6a039d.js';
...
let HoneyFeedVerwaltung = class {
  ...
  async addUrl() {
    if (!newsService)
      return;
    const urlRaw = this.inputNewUrl.value;
    // sanitize user input
    const urlClean = purify.sanitize(urlRaw);
    const url = urlClean.trim();
...
export { HoneyFeedVerwaltung as honey_news_verwaltung };
