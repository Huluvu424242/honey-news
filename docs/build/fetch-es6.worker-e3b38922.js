...
async function getFeedsSingleCall(feedURLs, withStatistic) {
  return await lastValueFrom(from(feedURLs).pipe(mergeMap((url) => {
...
exports.getFeedsSingleCall = getFeedsSingleCall;
