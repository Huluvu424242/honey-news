...
import { f as from, d as toArray, E as EMPTY, e as map, g as tap } from './index-d9553567.js';
...
let HoneyNewsFeed = class {
  ...
  async componentWillLoad() {
    var _a;
    const feeds = this.feedLoader.getFeedURLs();
    const posts = await getFeedsSingleCall([feeds[0]], false);
    this.lastUpdate = ((_a = posts[0]) === null || _a === void 0 ? void 0 : _a.exaktdate) || this.lastUpdate;
    this.feeds = [...posts];
  }
  subscribeFeeds() {
    return this.feedLoader.getFeedsPeriodicObservable$().subscribe((posts) => {
      var _a;
      this.lastUpdate = ((_a = posts[0]) === null || _a === void 0 ? void 0 : _a.exaktdate) || this.lastUpdate;
      this.feeds = [...posts];
    });
  ...
  initialisiereUrls() {
    ...
    from(predefinedURLs).pipe(tap(url => this.feedLoader.addFeedUrl(url))).subscribe();
  }
