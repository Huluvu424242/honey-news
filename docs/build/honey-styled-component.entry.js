...
const HoneyStyledComponent = class {
  constructor(hostRef) {
  ...
  async connectedCallback() {
    try {
      ...
      const listener = {
        ...
        complete: () => undefined("subcription completed")
      };
  ...
  render() {
    ...
    return (h(TagName, null, h("slot", { name: "slot1", slot: "slot1" }, "placeholder slot 1"), h("slot", { name: "slot2", slot: "slot2" }, "placeholder slot 2"), h("slot", { name: "slot3", slot: "slot3" }, "placeholder slot 3"), h("slot", { name: "slot4", slot: "slot4" }, "placeholder slot 4"), h("slot", { name: "slot5", slot: "slot5" }, "placeholder slot 5"), h("slot", { name: "slot6", slot: "slot6" }, "placeholder slot 6"), h("slot", { name: "slot7", slot: "slot7" }, "placeholder slot 7"), h("slot", { name: "slot8", slot: "slot8" }, "placeholder slot 8"), h("slot", { name: "slot9", slot: "slot9" }, "placeholder slot 9"), h("slot", { name: "slot10", slot: "slot10" }, "placeholder slot 10")));
  }
};
